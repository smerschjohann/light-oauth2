...
VALUES('f7d42348-c647-4efb-a52d-4c5787421e72', 'f6h1FTI8Q3-7UScPZDzfXA', 'server', 'PetStore Web Server', 'PetStore Web Server that calls PetStore API', 'petstore.r petstore.w', 'http://localhost:8080/authorization', 'admin', current_timestamp);
