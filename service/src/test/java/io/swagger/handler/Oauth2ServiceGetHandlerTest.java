...
public class Oauth2ServiceGetHandlerTest {
    ...
    public void testOauth2ServiceGetHandler() throws ClientException, ApiException {
        ...
        HttpGet httpGet = new HttpGet("http://localhost:8080/v1/oauth2/service");
        /*
        Client.getInstance().addAuthorization(httpPost);
        try {
            CloseableHttpResponse response = client.execute(httpGet);
            Assert.assertEquals(200, response.getStatusLine().getStatusCode());
            Assert.assertEquals("getAllService", IOUtils.toString(response.getEntity().getContent(), "utf8"));
        } catch (Exception e) {
            e.printStackTrace();
        }
        */
