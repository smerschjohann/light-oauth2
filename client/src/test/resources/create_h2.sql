...
INSERT INTO clients (client_id, client_type, client_secret, client_name, client_desc, scope, redirect_url) VALUES('59f347a0-c92d-11e6-9d9d-cec0c932ce01', 'server', 'f6h1FTI8Q3-7UScPZDzfXA', 'PetStore Web Server', 'PetStore Web Server that calls PetStore API', 'petstore.r petstore.w', 'http://localhost:8080/authorization' );
